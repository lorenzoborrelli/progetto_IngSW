...
public class Querys {
	...
	public static void addSession(int type, String text, Vector<Integer> v, boolean quorum) {
		try {
	...
	public static SessionWinner getWinner(Session session, boolean isReferendum) {
		try {
			String query;
			if(isReferendum)
	...
	public static void registerUser(String name, String surname, String cf, boolean isAdmin, String email, String password) {
		try {
	...
	public static void terminateSession(Session s) {
		try {
