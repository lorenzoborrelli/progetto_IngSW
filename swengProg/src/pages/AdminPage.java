...
public class AdminPage extends Pages {
	...
	public void addFClicked(MouseEvent e) {
		...
		Querys.addFaction( ((TextField)scene.lookup("#addFName")).getText() );
	...
	public void addCClicked(MouseEvent e) {
		...
		Querys.addCandidate( name, surname, factionID );
	...
	public void addVotClicked(MouseEvent e) {
		...
		Querys.addSession( type, ((TextField)scene.lookup("#nomeVotazione")).getText() , factionIDs , quorum );
